...
// TestObjects
TestObject menuButton           = findTestObject('Object Repository/case_14/case-9/android.widget.ImageButton')
TestObject locationSettingsOpt  = findTestObject('Object Repository/case_14/case-9/android.widget.TextView - Location settings')
TestObject daytimeUpdatesText   = findTestObject('Object Repository/case_14/case-9/android.widget.TextView - Daytime only updates')
TestObject okButton             = findTestObject('Object Repository/case_14/case-9/android.widget.Button - OK')
TestObject saveButton           = findTestObject('Object Repository/case_14/case-9/android.widget.Button - Save')
