...
TestObject pendingTab          = findTestObject('Object Repository/Test_8/android.widget.TextView - Pending')
TestObject contactRadioButton  = findTestObject('Object Repository/Test_8/android.widget.RadioButton - Contact (1)')
...
TestObject okButton            = findTestObject('Object Repository/Test_8/android.widget.Button - OK')
