...
if (isVisible) {
	...
	Mobile.tap(findTestObject('Object Repository/Test_3/android.widget.Button - Delete alarm'), 0)
	
	Mobile.tap(findTestObject('Object Repository/Test_3/android.widget.Button - Remove alarm'), 0)
