...
Mobile.tap(findTestObject('Object Repository/Test_8/android.widget.TextView - Pending'), 0)

Mobile.tap(findTestObject('Object Repository/Test_8/android.widget.RadioButton - Contact (1)'), 0)
