...
// TestObjects
TestObject menuButton           = findTestObject('Object Repository/case_14/case-11/android.widget.ImageButton')
TestObject presetMessagesOpt    = findTestObject('Object Repository/case_14/case-11/android.widget.TextView - Preset messages')
TestObject presetMessagesText   = findTestObject('Object Repository/case_14/case-11/android.widget.TextView - Preset messages (1)')
TestObject editButton           = findTestObject('Object Repository/case_14/case-11/android.widget.ImageButton (1)')
TestObject messageInputField    = findTestObject('Object Repository/case_14/case-11/android.widget.EditText - Enter your preset message')
TestObject saveButton           = findTestObject('Object Repository/case_14/case-11/android.widget.Button - Save')
...
Mobile.waitForElementPresent(editButton, 10)
Mobile.tap(editButton, 0)
KeywordUtil.logInfo('Tapped Edit button to add new preset message')
