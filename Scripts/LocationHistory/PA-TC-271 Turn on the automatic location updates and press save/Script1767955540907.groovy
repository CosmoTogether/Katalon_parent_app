...
// TestObjects
TestObject menuButton          = findTestObject('Object Repository/case_14/case-6/android.widget.ImageButton')
TestObject locationSettingsOpt = findTestObject('Object Repository/case_14/case-6/android.widget.TextView - Location settings')
TestObject autoUpdatesText     = findTestObject('Object Repository/case_14/case-6/android.widget.TextView - Automatic Location Updates')
TestObject switchObj           = findTestObject('Object Repository/case_14/case-6/android.widget.Switch')
TestObject saveButton          = findTestObject('Object Repository/case_14/case-6/android.widget.Button - Save')
...
Mobile.tap(switchObj, 0)
KeywordUtil.logInfo('Toggled Automatic Location Updates switch')

// Check if switch is enabled
String isEnabled = Mobile.getAttribute(switchObj, 'enabled', 5)
if (isEnabled == 'true') {
	KeywordUtil.logInfo('Switch is ENABLED')
} else {
	KeywordUtil.logInfo('Switch is DISABLED')
}
