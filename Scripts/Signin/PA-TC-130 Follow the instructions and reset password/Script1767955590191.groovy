...
// TestObjects
TestObject signInBtn          = findTestObject('Object Repository/case-4/android.widget.Button - Sign in')
TestObject forgotPasswordBtn  = findTestObject('Object Repository/case-4/android.widget.Button - Forgot password')
TestObject emailField         = findTestObject('Object Repository/case-4/android.widget.EditText - Enter email (1)')
TestObject changePasswordBtn  = findTestObject('Object Repository/case-4/android.widget.Button - Change password')
TestObject passwordSentTxt    = findTestObject('Object Repository/case-4/android.widget.TextView - Password update request sent')
TestObject okButton           = findTestObject('Object Repository/case-4/android.widget.Button - OK')
