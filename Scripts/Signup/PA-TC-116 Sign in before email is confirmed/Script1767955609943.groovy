...
//import com.kms.katalon.core.mobile.keyword.internal.MobileTestObject
import com.kms.katalon.core.mobile.keyword.MobileBuiltInKeywords as Mobile
...
// TestObjects
TestObject signInButton       = findTestObject('Object Repository/PA-TC-116/android.widget.Button - Sign in')
TestObject emailField         = findTestObject('Object Repository/PA-TC-116/android.widget.AutoCompleteTextView - Email')
TestObject passwordField      = findTestObject('Object Repository/PA-TC-116/android.widget.EditText - Password')
TestObject signInButtonFinal  = findTestObject('Object Repository/PA-TC-116/android.widget.Button - Sign in (1)')
TestObject invalidCredsText   = findTestObject('Object Repository/PA-TC-116/android.widget.TextView - This email address or password is invalid')
