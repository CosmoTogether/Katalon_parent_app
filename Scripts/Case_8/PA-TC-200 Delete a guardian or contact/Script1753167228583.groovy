...
Mobile.tap(findTestObject('Object Repository/Test_8/android.widget.RelativeLayout-1'), 0)

Mobile.tap(findTestObject('Object Repository/Test_8/android.widget.Button - Delete contact'), 0)

Mobile.tap(findTestObject('Object Repository/Test_8/android.widget.Button - OK (1)'), 0)
