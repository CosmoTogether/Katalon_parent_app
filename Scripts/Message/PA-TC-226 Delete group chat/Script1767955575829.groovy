...
// TestObjects
TestObject menuButton        = findTestObject('Object Repository/case_12/case-7/android.widget.ImageButton')
TestObject messagesOption    = findTestObject('Object Repository/case_12/case-7/android.widget.CheckedTextView - Messages')
TestObject firstGroupImage   = findTestObject('Object Repository/case_12/case-7/android.widget.ImageView')
TestObject editGroupText     = findTestObject('Object Repository/case_12/case-7/android.widget.TextView - Edit group Chat')
TestObject deleteGroupButton = findTestObject('Object Repository/case_12/case-7/android.widget.Button - Delete group chat')
TestObject deletedToast      = findTestObject('Object Repository/case_12/case-7/android.widget.Toast - Deleted')
