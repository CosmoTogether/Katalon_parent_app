...
// TestObjects
TestObject menuButton        = findTestObject('Object Repository/case_12/case-4/android.widget.ImageButton')
TestObject messagesOption    = findTestObject('Object Repository/case_12/case-4/android.widget.CheckedTextView - Messages')
TestObject newGroupButton    = findTestObject('Object Repository/case_12/case-4/android.widget.ImageButton (1)')
TestObject saveButton        = findTestObject('Object Repository/case_12/case-4/android.widget.Button - Save')
TestObject groupNameToast    = findTestObject('Object Repository/case_12/case-4/android.widget.Toast - Group name')
