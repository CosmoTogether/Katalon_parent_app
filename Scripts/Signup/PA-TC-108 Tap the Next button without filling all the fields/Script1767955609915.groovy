...
// TestObjects
TestObject createBtn      = findTestObject('Object Repository/PA-TC-109/android.widget.Button - Create an account')
TestObject nextButton    = findTestObject('Object Repository/PA-TC-108/android.widget.Button - Next')
TestObject titleText     = findTestObject('Object Repository/PA-TC-108/android.widget.TextView - Create Parent Account')
