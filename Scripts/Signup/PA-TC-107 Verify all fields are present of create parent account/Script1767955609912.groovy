...
// TestObjects
TestObject createAccountBtn   = findTestObject('Object Repository/PA-TC-107/android.widget.Button - Create an account')
TestObject titleText         = findTestObject('Object Repository/PA-TC-107/android.widget.TextView - Create Parent Account')
TestObject firstNameField   = findTestObject('Object Repository/PA-TC-107/android.widget.EditText - First name')
TestObject lastNameField    = findTestObject('Object Repository/PA-TC-107/android.widget.EditText - Last name')
TestObject emailField       = findTestObject('Object Repository/PA-TC-107/android.widget.EditText - Email')
TestObject passwordField   = findTestObject('Object Repository/PA-TC-107/android.widget.EditText - Password (8 or more characters)')
TestObject confirmPassField= findTestObject('Object Repository/PA-TC-107/android.widget.EditText - Confirm Password')
TestObject nextButton      = findTestObject('Object Repository/PA-TC-107/android.widget.Button - Next')
