...
Mobile.setText(findTestObject('Object Repository/Test_8/android.widget.EditText - First name'), 'testuser1', 0)

Mobile.tap(findTestObject('Object Repository/Test_8/android.widget.Button - Save'), 0)

Mobile.verifyElementVisible(findTestObject('Object Repository/Test_8/android.widget.TextView - Add Contact'), 0)
