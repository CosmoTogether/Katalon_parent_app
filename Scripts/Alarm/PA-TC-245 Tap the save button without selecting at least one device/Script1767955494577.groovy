...
TestObject switchButton      = findTestObject('Object Repository/Test_3/android.widget.Switch')
...
KeywordUtil.logInfo('Tapped Switch button')
...
// Step 10: Verify "Set new alarm" screen
try {
