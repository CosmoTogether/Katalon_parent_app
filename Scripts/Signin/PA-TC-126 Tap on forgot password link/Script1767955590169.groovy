...
// TestObjects
TestObject signInButton       = findTestObject('Object Repository/case-1/android.widget.Button - Sign in')
TestObject forgotPasswordBtn  = findTestObject('Object Repository/case-1/android.widget.Button - Forgot password')
TestObject forgotPasswordText = findTestObject('Object Repository/case-1/android.widget.TextView - Forgot password')
