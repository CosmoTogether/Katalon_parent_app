...
TestObject imageButton     = findTestObject('Object Repository/case_2/case-1/android.widget.ImageButton')
TestObject imageView       = findTestObject('Object Repository/case_2/case-1/android.widget.ImageView')
TestObject relativeLayout  = findTestObject('Object Repository/case_2/case-1/android.widget.RelativeLayout')
TestObject linearLayout    = findTestObject('Object Repository/case_2/case-1/android.widget.LinearLayout')
TestObject linearLayout1   = findTestObject('Object Repository/case_2/case-1/android.widget.LinearLayout (1)')
TestObject relativeLayout1 = findTestObject('Object Repository/case_2/case-1/android.widget.RelativeLayout (1)')
TestObject relativeLayout2 = findTestObject('Object Repository/case_2/case-1/android.widget.RelativeLayout (2)')
...
// Verify ImageView
Mobile.waitForElementPresent(imageView, 10)
try {
	Mobile.verifyElementVisible(imageView, 0, FailureHandling.STOP_ON_FAILURE)
	println 'Verified ImageView element'
} catch (Exception e) {
	println 'ImageView verification failed: ' + e.getMessage()
}

// Verify RelativeLayout
Mobile.waitForElementPresent(relativeLayout, 10)
try {
	Mobile.verifyElementVisible(relativeLayout, 0, FailureHandling.STOP_ON_FAILURE)
	println 'Verified RelativeLayout element'
} catch (Exception e) {
	println 'RelativeLayout verification failed: ' + e.getMessage()
}
