...
TestObject alarmNameField   = findTestObject('Object Repository/Test_3/android.widget.EditText - Alarm name')
...
Mobile.setText(alarmNameField, alram_name, 0)
KeywordUtil.logInfo("Entered alarm name: ${alram_name}")
...
// Step 7: Verify "Set new alarm" screen
try {
...
// Optional: Take screenshot for report
