...
TestObject contactItem         = findTestObject('Object Repository/Test_8/android.widget.TextView - test test')
TestObject guardianRadioButton = findTestObject('Object Repository/Test_8/android.widget.RadioButton - Guardian')
TestObject emailField          = findTestObject('Object Repository/Test_8/android.widget.EditText - Email')
TestObject saveButton          = findTestObject('Object Repository/Test_8/android.widget.Button - Save')
TestObject confirmButton       = findTestObject('Object Repository/Test_8/android.widget.Button - CONFIRM')
...
// Verification wrapped in try-catch
try {
	Mobile.waitForElementPresent(allContactsText, 10)
	Mobile.verifyElementText(allContactsText, verify_contact_text)
	println '"All contacts" text verified'
