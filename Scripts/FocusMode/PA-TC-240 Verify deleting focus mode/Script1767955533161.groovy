...
// TestObjects
TestObject menuButton       = findTestObject('Object Repository/case_13/case-12/android.widget.ImageButton')
TestObject activityCenter   = findTestObject('Object Repository/case_13/case-12/android.widget.CheckedTextView - Activity Center')
TestObject focusModeOption  = findTestObject('Object Repository/case_13/case-12/android.widget.TextView - Focus mode')
TestObject focusItem        = findTestObject('Object Repository/case_13/case-12/android.widget.LinearLayout')
TestObject editFocusText    = findTestObject('Object Repository/case_13/case-12/android.widget.TextView - Edit focus mode')
TestObject deleteButton     = findTestObject('Object Repository/case_13/case-12/android.widget.Button - Delete focus mode')
TestObject okButton         = findTestObject('Object Repository/case_13/case-12/android.widget.Button - OK')
TestObject toastMessage     = findTestObject('Object Repository/case_13/case-12/android.widget.Toast - Focus mode deleted')
