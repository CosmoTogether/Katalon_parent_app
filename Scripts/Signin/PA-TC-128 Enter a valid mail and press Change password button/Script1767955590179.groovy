...
// TestObjects
TestObject signInButton      = findTestObject('Object Repository/case-3/android.widget.Button - Sign in')
TestObject emailField        = findTestObject('Object Repository/case-3/android.widget.AutoCompleteTextView - Email')
TestObject passwordField     = findTestObject('Object Repository/case-3/android.widget.EditText - Password')
TestObject forgotPasswordBtn = findTestObject('Object Repository/case-1/android.widget.Button - Forgot password')
TestObject forgotPasswordTxt = findTestObject('Object Repository/case-1/android.widget.TextView - Forgot password')
