...
// TestObjects
TestObject createBtn      = findTestObject('PA-TC-109/android.widget.Button - Create an account')
TestObject firstNameFld  = findTestObject('PA-TC-109/android.widget.EditText - First name')
TestObject lastNameFld   = findTestObject('PA-TC-109/android.widget.EditText - Last name')
TestObject emailFld      = findTestObject('PA-TC-109/android.widget.EditText - Email')
TestObject passwordFld  = findTestObject('PA-TC-109/android.widget.EditText - Password (8 or more characters)')
TestObject confirmPwdFld= findTestObject('PA-TC-109/android.widget.EditText - Confirm Password')
TestObject termsCheckbox= findTestObject('PA-TC-109/android.widget.CheckBox')
TestObject nextBtn      = findTestObject('Object Repository/PA-TC-109/android.widget.Button - Next')
TestObject titleText   = findTestObject('Object Repository/PA-TC-109/android.widget.TextView - Create Parent Account')
...
try {
	...
	println 'Create Parent Account screen verified'
} catch (Exception e) {
