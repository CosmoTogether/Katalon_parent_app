...
TestObject notificationsTab  = findTestObject('Object Repository/case_2/case-3/android.widget.FrameLayout')
TestObject notificationsText = findTestObject('Object Repository/case_2/case-3/android.widget.TextView - Notifications')
TestObject clearAllButton    = findTestObject('Object Repository/case_2/case-3/android.widget.Button - Clear all')
TestObject okButton          = findTestObject('Object Repository/case_2/case-3/android.widget.Button - OK')
TestObject toastMessages     = findTestObject('Object Repository/case_2/case-3/android.widget.Toast - Messages Removed')
