...
// TestObjects
TestObject menuButton           = findTestObject('Object Repository/case_14/case-7/android.widget.ImageButton')
TestObject locationSettingsOpt  = findTestObject('Object Repository/case_14/case-7/android.widget.TextView - Location settings')
TestObject daytimeUpdatesText   = findTestObject('Object Repository/case_14/case-7/android.widget.TextView - Daytime only updates')
TestObject setDaytimeRangeText  = findTestObject('Object Repository/case_14/case-7/android.widget.TextView - Set Daytime range')
TestObject okButton             = findTestObject('Object Repository/case_14/case-7/android.widget.Button - OK')
