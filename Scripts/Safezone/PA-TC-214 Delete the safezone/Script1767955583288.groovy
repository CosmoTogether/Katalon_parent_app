...
// TestObjects
TestObject menuButton      = findTestObject('Object Repository/case_11/case-9/android.widget.ImageButton')
TestObject safeZonesItem   = findTestObject('Object Repository/case_11/case-9/android.widget.CheckedTextView - SafeZones')
TestObject firstZoneItem   = findTestObject('Object Repository/case_11/case-9/android.view.ViewGroup')
TestObject deleteButton    = findTestObject('Object Repository/case_11/case-9/android.widget.Button - Delete SafeZone')
TestObject okButton        = findTestObject('Object Repository/case_11/case-9/android.widget.Button - OK')
...
try {
	Mobile.verifyElementVisible(firstZoneItem, 5)
