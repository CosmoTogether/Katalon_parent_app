...
// TestObjects
TestObject menuButton       = findTestObject('Object Repository/case_12/case-5/android.widget.ImageButton')
TestObject messagesOption   = findTestObject('Object Repository/case_12/case-5/android.widget.CheckedTextView - Messages')
TestObject newGroupButton   = findTestObject('Object Repository/case_12/case-5/android.widget.ImageButton (1)')
TestObject groupNameField   = findTestObject('Object Repository/case_12/case-5/android.widget.EditText - Group name')
TestObject switchButton     = findTestObject('Object Repository/case_12/case-5/android.widget.Switch')
TestObject saveButton       = findTestObject('Object Repository/case_12/case-5/android.widget.Button - Save')
