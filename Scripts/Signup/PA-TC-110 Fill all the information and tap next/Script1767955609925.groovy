...
// TestObjects
TestObject createBtn      = findTestObject('Object Repository/PA-TC-110/android.widget.Button - Create an account')
TestObject firstNameFld  = findTestObject('Object Repository/PA-TC-110/android.widget.EditText - First name')
TestObject lastNameFld   = findTestObject('Object Repository/PA-TC-110/android.widget.EditText - Last name')
TestObject emailFld      = findTestObject('Object Repository/PA-TC-110/android.widget.EditText - Email')
TestObject passwordFld  = findTestObject('Object Repository/PA-TC-110/android.widget.EditText - Password (8 or more characters)')
TestObject confirmPwdFld= findTestObject('Object Repository/PA-TC-110/android.widget.EditText - Confirm Password')
TestObject termsCheckbox= findTestObject('Object Repository/PA-TC-110/android.widget.CheckBox')
TestObject nextBtn      = findTestObject('Object Repository/PA-TC-110/android.widget.Button - Next')
TestObject addPicText   = findTestObject('Object Repository/PA-TC-110/android.widget.TextView - Add a profile picture')
TestObject titleText   = findTestObject('Object Repository/PA-TC-110/android.widget.TextView - Create Parent Account')
